...
```bash
curl -fsSL https://raw.githubusercontent.com/joaoha/sparkdashboard/ad1628e9e434761b77d242590e96c7202cd9f5ed/bootstrap.sh | SPARKDASHBOARD_REF=ad1628e9e434761b77d242590e96c7202cd9f5ed bash -s -- --models all --packages all --start dashboard
```

Add `--package-models all` if this fresh machine should also download optional app model weights in the same run.

The command pins both the bootstrap script and installed source tree to immutable Git commit `ad1628e9e434761b77d242590e96c7202cd9f5ed`. The bootstrap checks out that installer revision in a disposable temporary directory, so it is safe to rerun after an interrupted or failed install. Completed optional-package Git checkouts are reused; a partial clone is preserved as a timestamped `.interrupted-clone-*` sibling and replaced with a clean retry.
...
```bash
curl -fsSL https://raw.githubusercontent.com/joaoha/sparkdashboard/ad1628e9e434761b77d242590e96c7202cd9f5ed/bootstrap.sh | SPARKDASHBOARD_REF=ad1628e9e434761b77d242590e96c7202cd9f5ed bash -s -- --skip-model-download --start dashboard
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/joaoha/sparkdashboard/ad1628e9e434761b77d242590e96c7202cd9f5ed/bootstrap.sh | SPARKDASHBOARD_REF=ad1628e9e434761b77d242590e96c7202cd9f5ed bash -s -- \
...
```bash
curl -fsSL https://raw.githubusercontent.com/joaoha/sparkdashboard/ad1628e9e434761b77d242590e96c7202cd9f5ed/bootstrap.sh | SPARKDASHBOARD_REF=ad1628e9e434761b77d242590e96c7202cd9f5ed bash -s -- --dry-run --models none --start none \
