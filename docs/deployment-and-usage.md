...
```bash
curl -fsSL https://raw.githubusercontent.com/joaoha/sparkdashboard/07c25d552b5ad461a366b9a45eeb77ebe7ed3acf/bootstrap.sh | SPARKDASHBOARD_REF=07c25d552b5ad461a366b9a45eeb77ebe7ed3acf bash -s -- --dry-run --models none --start none \
