...
```bash
curl -fsSL https://raw.githubusercontent.com/joaoha/sparkdashboard/2b0c42494ca81c93d5bc34ad439a4ef4b7228140/bootstrap.sh | SPARKDASHBOARD_REF=2b0c42494ca81c93d5bc34ad439a4ef4b7228140 bash -s -- --models all --packages all --start dashboard
```

Add `--package-models all` if this fresh machine should also download optional app model weights in the same run.

The command pins both the bootstrap script and installed source tree to immutable Git commit `2b0c42494ca81c93d5bc34ad439a4ef4b7228140`. The bootstrap checks out that installer revision in a disposable temporary directory, so it is safe to rerun after an interrupted or failed install. Completed optional-package Git checkouts are reused; a partial clone is preserved as a timestamped `.interrupted-clone-*` sibling and replaced with a clean retry.
...
```bash
curl -fsSL https://raw.githubusercontent.com/joaoha/sparkdashboard/2b0c42494ca81c93d5bc34ad439a4ef4b7228140/bootstrap.sh | SPARKDASHBOARD_REF=2b0c42494ca81c93d5bc34ad439a4ef4b7228140 bash -s -- --skip-model-download --start dashboard
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/joaoha/sparkdashboard/2b0c42494ca81c93d5bc34ad439a4ef4b7228140/bootstrap.sh | SPARKDASHBOARD_REF=2b0c42494ca81c93d5bc34ad439a4ef4b7228140 bash -s -- \
...
```bash
curl -fsSL https://raw.githubusercontent.com/joaoha/sparkdashboard/2b0c42494ca81c93d5bc34ad439a4ef4b7228140/bootstrap.sh | SPARKDASHBOARD_REF=2b0c42494ca81c93d5bc34ad439a4ef4b7228140 bash -s -- --dry-run --models none --start none \
