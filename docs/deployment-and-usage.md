...
```bash
curl -fsSL https://raw.githubusercontent.com/joaoha/sparkdashboard/8045efee4683308f77817604e38714a0bb9a0b61/bootstrap.sh | SPARKDASHBOARD_REF=8045efee4683308f77817604e38714a0bb9a0b61 bash -s -- --skip-model-download --start dashboard
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/joaoha/sparkdashboard/8045efee4683308f77817604e38714a0bb9a0b61/bootstrap.sh | SPARKDASHBOARD_REF=8045efee4683308f77817604e38714a0bb9a0b61 bash -s -- \
...
```bash
curl -fsSL https://raw.githubusercontent.com/joaoha/sparkdashboard/8045efee4683308f77817604e38714a0bb9a0b61/bootstrap.sh | SPARKDASHBOARD_REF=8045efee4683308f77817604e38714a0bb9a0b61 bash -s -- --dry-run --models none --start none \
